...
import { CustomerGridRoutingModule } from '../../customer-grid/customer-grid-routing.module';
...
@NgModule({
  ...
  exports:[CustomerOrderGridComponent] 
})
export class CustomerOrderGridModule {
}
