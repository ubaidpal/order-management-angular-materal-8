...
import icMovetoinbox from '@iconify/icons-ic/move-to-inbox';
import icDirectionsBoat from '@iconify/icons-ic/directions-boat';
...
export class DashboardAnalyticsComponent implements OnInit {
  ...
  icDirectionsBoat = icDirectionsBoat;
